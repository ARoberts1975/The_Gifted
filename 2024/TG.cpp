...
cout << "PLEASE DO NOT DISTRIBUTE, COPY, TRANSLATE, DISASSEMBLE, REVERSE COMPILE, OR" << endl;
cout << "MODIFY THIS PROGRAM OR IT'S CONTENTS IN ANY WAY\n" << endl;
cout << "Given to you in good faith by the author.\n\n\n\n\n\n\n\n\n\n\n" << endl;
system("pause");
tgmenu();
return 0;
}
